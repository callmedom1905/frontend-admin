...
interface NotificationModalProps {
  ...
  onReject?: () => void;
  onClose?: () => void;
  customContent?: React.ReactNode; // Thêm prop để render custom content
  showDefaultButtons?: boolean; // Cho phép ẩn/hiện buttons mặc định
}
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {description && (
            <div className="text-gray-500 text-sm mb-4 whitespace-pre-line">{description}</div>
          )}
          ...
          {/* Default buttons - chỉ hiển thị khi showDefaultButtons = true */}
          {showDefaultButtons === true && (
