...
const StaffForm: React.FC<StaffFormProps> = ({ onSubmit, editStaff }) => {
  ...
  const submitHandler = async (data: StaffFormData) => {
    ...
    try {
      ...
      // Xử lý lỗi validation từ backend với format errors
    ...
    <div className="flex flex-col">
      ...
      <div className="relative">
        <input
          ...
          className={`border-2 rounded-lg px-4 py-2 w-full focus:outline-none focus:border-[#D4AF37] transition ${errors[name] ? "border-red-400" : "border-gray-200"
            }`}
      ...
      <div className="w-full grid grid-cols-1 gap-y-4">
        ...
        {renderInput(
          ...
          </svg>,
          {
            ...
            pattern: { 
              value: /^0[0-9]{9,10}$/, 
              message: "Số điện thoại phải bắt đầu bằng số 0 và có 10-11 số" 
            }
          }
        )}
