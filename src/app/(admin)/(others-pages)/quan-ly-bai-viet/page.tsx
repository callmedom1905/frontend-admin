...
export default function PostListPage() {
  ...
  delete postData.seo_score;
  delete postData.seo_grade;

      console.log("Final post data being sent:", postData);
      console.log("Image field value:", postData.image);
  console.log("OG image field value:", postData.og_image);
  console.log("Twitter image field value:", postData.twitter_image);

      const response = await apiClient.put(`/posts/${updatedPost.id}`, postData);
      console.log("Update post response:", response);

      if ((response as { success: boolean; data: Post; message?: string }).success) {
        setEditingPost(null);
  ...
  return (
    <div>
      ...
      {reviewingPost && (
        <PostReview post={reviewingPost} onClose={() => setReviewingPost(null)} />
      )}
